...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        ...
        "     TexCoord1 = vTexCoord + offset1 * 0.00005;                                                                         \n"
      
        "     TexCoord2 = vTexCoord + offset2 * 0.00005;                                                                         \n"
       
        "     TexCoord3 = vTexCoord + offset3 * 0.00005;                                                                         \n"

        "     TexCoord4 = vTexCoord + offset4 * 0.00005;                                                                         \n"
...
"    highp float distance1  =  length(depth - depth1);                                                                         \n"
"    originalPixel          =  originalPixel * NdotN1 +distance1;                                                                                         \n"

"    highp float distance2  =  length(depth - depth2);                                                                         \n"
"    originalPixel          =  originalPixel * NdotN2 + distance2;                                                                                         \n"

"    highp float distance3  =  length(depth - depth3);                                                                         \n"
"    originalPixel          = originalPixel * NdotN3 + distance3;                                                                                         \n"

"    highp float distance4  =  length(depth - depth4);                                                                         \n"
"    originalPixel          =  originalPixel * NdotN4 + distance4;                                                                                         \n"


"    originalPixel         *=    originalPixel * originalPixel* originalPixel* originalPixel;                                                                                         \n"
